...
const Windows = (props) => (
  <svg viewBox="0 0 88 88" xmlns="http://www.w3.org/2000/svg" width={70} height={70} {...props}>
    <path
...
const Linux = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={70} height={70} viewBox="0 0 256 295" {...props}>
    <defs>
